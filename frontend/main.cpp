        ...
        Sh3Runtime& runtime)
{
        ...
        case 0:
                ...
                break;
        case 1:
                comm.mNext = Session(ios, "127.0.0.1:1314", SessionMode::Server, "12").addChannel();
        ...
        default:
                ...
                comm.mPrev = Session(ios, "127.0.0.1:1314", SessionMode::Client, "12").addChannel();
                break;
        }
...
int main(void) {
        ...
        if (single_term) {
                ...
                pid = fork();
                if (pid != 0) {
                        std::cout << "Run party 1:" << std::endl;
                        fixedPointOperations(1);
                        return 0;
                }

                std::cout << "Run party 0:" << std::endl;
                ...
                if (getenv("MPC_PARTY_0") != nullptr) {
                        std::cout << "Run party 0:" << std::endl;
                        fixedPointOperations(0);
                } else if (getenv("MPC_PARTY_1") != nullptr) {
                        std::cout << "Run party 1:" << std::endl;
                        fixedPointOperations(1);
                } else {
                        std::cout << "Run party 2:" << std::endl;
